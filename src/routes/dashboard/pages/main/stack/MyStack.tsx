...
const ongoingBootcamps: Bootcamp[] = [
  {
    ...
    learnList: [
      "UI AND UX OVERVIEW",
      "DESIGNIGN THE TOP NOTCH FOR CLIENT",
    ...
    reviews: [
      {
        ...
        date: "3 weeks ago",
        comment:
          "Teaching style and patterns are very extremely good. Appropriate amount of exercise to gets hands on the tool and understanding how exactly Figma works.",
      },
      {
        id: "rev2",
        name: "Jenny Miu",
        ...
        date: "3 weeks ago",
        comment:
          "The pace of the cohort was perfect for someone starting from scratch. Highly recommended!",
      },
    ],
    discussions: [
      {
  ...
  //============= SECOND ID=======
  {
    ...
    description:
      "Deep dive into all the laws of UX and basic design principles",
    duration: "6 Weeks",
    progress: 30,
