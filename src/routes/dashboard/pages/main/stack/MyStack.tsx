...
import StackOngoingCourses from "../../../../../components/dashboard/MyStackpage/MyStackCourses/StackOngoingCourses";
import StackAddedToCart from "../../../../../components/dashboard/MyStackpage/MyStackCourses/StackAddedToCart";
import StackCompletedCourses from "../../../../../components/dashboard/MyStackpage/MyStackCourses/StackCompletedCourses";
          ...
          <>
            ...
            >
              ...
              >
                <Typography
                  variant="h4"
                  sx={{ fontWeight: 700, mb: 1, px: { xs: 1, sm: 2, md: 2, fontFamily:theme.typography.fontFamily, } }}
                >
                  Ongoing Courses
                </Typography>
