...
// Images
import uiuxImg from "../../../dashboard/assets/images/microbootcamps/uiux.png";
import contentImg from "../../../dashboard/assets/images/microbootcamps/content.png";
import webdevImg from "../../../dashboard/assets/images/microbootcamps/webdev.png";

export const microbootcamps = [
  {
    image: uiuxImg,
...
const data = [...microbootcamps, ...microbootcamps];

const OngoingBootcamps: React.FC = () => {
...
export default OngoingBootcamps;
