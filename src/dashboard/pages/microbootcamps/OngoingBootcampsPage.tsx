...
// Images
import uiuxImg from "../../assets/images/microbootcamps/uiux.png";
import contentImg from "../../assets/images/microbootcamps/content.png";
import webdevImg from "../../assets/images/microbootcamps/webdev.png";
...
const OngoingBootcampsPage: React.FC = () => {
                ...
                {items.map((item, index) => (
                  ...
                  >
                    <Box sx={{ position: "relative" }}>
                      ...
                      <Chip
                        label="● Live"
                        sx={{ position: "absolute", top: 8, left: 8, background: "#FF4D4F", color: "#fff", fontSize: "0.6rem", height: 18, borderRadius: 1 }}
                      />
                    </Box>
...
export default OngoingBootcampsPage;
